...
def benefits_page():
    ...
    with col1:
        st.markdown("""
        <div style='font-size:22px; line-height:1.6; color:white;'>
        A wind turbine consists of blades that catch the wind, a rotor that converts it into electricity, and a tower that supports the structure. A wind turbine converts the kinetic energy of the wind into electrical energy. When the wind blows, it pushes against the turbine blades, causing them to rotate. These blades are shaped like airplane wings and create a pressure difference that efficiently captures the wind.
...
def types_page():
    ...
    <div style='display:flex; align-items:center; justify-content:space-between; gap:40px; margin-bottom:30px;'>
        ...
        <div style='flex:1; text-align:center;'>
            <img src='https://www.inceptivemind.com/wp-content/uploads/2021/06/Wind-Turbine.jpg' 
                 width='500' style='border-radius:15px;'>
        </div>
    </div>
